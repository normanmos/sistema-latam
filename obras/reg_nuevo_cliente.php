...
<body>
    ...
    <section id="container">
        <div class="form_register">
            ...
            <form action="clases/cliente/registrar.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="text_texto" name="iiva" id="iiva" required>
                </div>
                <div class="form-group">
                    <span class="label success">% R. Renta</span>
                    <input type="text" class="text_texto" name="irenta" id="irenta" required>
                </div>
                <br>
