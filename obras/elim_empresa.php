...
<body>
    ...
    <section id="container">
        <div class="form_register">
            ...
            <form action="clases/empresa/eliminar.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="text_texto" name="Ruc" id="Ruc" value="<?php echo $Ruc?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="text_texto" name="Telefono" id="Telefono" value="<?php echo $Telefono?>" readonly>
                </div>
                <div class="form-group">
