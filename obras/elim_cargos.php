...
<body>
    ...
    <section id="container">
        <div class="form_register">
            ...
            <form action="clases/cargo/eliminar.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="text_small" name="Cargo" id="Cargo"
                        style='display: inline; width: 205px;' value="<?php echo $Cargo?>" readonly>
                    <input type="text" class="text_small" name="Sueldo" id="Sueldo"
                        style='display: inline; width: 205px;' value="<?php echo $Sueldo?>" readonly>
                </div>
                <br>
