...
$hoy = date("Y-m-d");
header("Content-Disposition: attachment; filename=Reporte_por_Obra_$hoy.xls");
?>
<table border="1" cellpadding="1" cellspacing="1">
    ...
    <?php        
    $sql = "SELECT O.IdOperacion,EM.Descripcion'Empresa',OB.Obra,
    ...
    WHERE O.IdEmpresa = '$cmbempresa' AND O.IdObra = '$cmbobra' AND O.Fecha BETWEEN '$Fdesde' AND '$Fhasta' AND O.IdEstado=1 ORDER BY O.IdOperacion ASC";
