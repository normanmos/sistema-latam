...
<body>
    ...
    <section id="container">
        ...
        <form action="reportes/reporteGeneralEmpresa.php" method="POST">
        ...
        <table>
            ...
            $consulta2 = ("SELECT O.IdOperacion,OB.Obra AS 'Obra',
            ...
            <tr>
                ...
                <td>
                    <a class="link_edit" href="edt_operacion.php?id=<?php echo $dat["IdOperacion"]; ?>"><img src="img/editar.png"/></a>
                    <a class="link_delete" href="elim_operacion.php?id=<?php echo $dat["IdOperacion"]; ?>"><img src="img/eliminar.png"/></a>
                </td>
            </tr>
            <?php } ?>
        </table>
